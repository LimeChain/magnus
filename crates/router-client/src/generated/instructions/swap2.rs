...
impl Swap2InstructionData {
    pub fn new() -> Self {
        Self { discriminator: [65, 75, 63, 76, 235, 91, 91, 136] }
    }
...
impl Swap2Builder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = Swap2InstructionArgs { data: self.data.clone().expect("data is not set"), order_id: self.order_id.clone().expect("order_id is not set") };
...
impl<'a, 'b> Swap2Cpi<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>, accounts: Swap2CpiAccounts<'a, 'b>, args: Swap2InstructionArgs) -> Self {
        Self {
            __program: program,
...
impl<'a, 'b> Swap2CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let args =
            Swap2InstructionArgs { data: self.instruction.data.clone().expect("data is not set"), order_id: self.instruction.order_id.clone().expect("order_id is not set") };
