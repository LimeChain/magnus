...
impl SwapRouteV2 {
    pub fn instruction(&self, args: SwapRouteV2InstructionArgs) -> solana_instruction::Instruction {
        self.instruction_with_remaining_accounts(args, &[])
    }

    #[allow(clippy::arithmetic_side_effects)]
    #[allow(clippy::vec_init_then_push)]
    pub fn instruction_with_remaining_accounts(&self, args: SwapRouteV2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
        ...
        let mut data = SwapRouteV2InstructionData::new().try_to_vec().unwrap();
...
pub struct SwapRouteV2InstructionData {
    discriminator: [u8; 8],
}

impl SwapRouteV2InstructionData {
    pub fn new() -> Self {
        Self { discriminator: [249, 91, 84, 33, 69, 22, 0, 135] }
    }
...
impl Default for SwapRouteV2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapRouteV2InstructionArgs {
    pub data: SwapArgs,
    pub order_id: u64,
}

impl SwapRouteV2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SwapRouteV2`.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
impl SwapRouteV2Builder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SwapRouteV2InstructionArgs { data: self.data.clone().expect("data is not set"), order_id: self.order_id.clone().expect("order_id is not set") };

        accounts.instruction_with_remaining_accounts(args, &self.__remaining_accounts)
    }
}

/// `swap_route_v2` CPI accounts.
pub struct SwapRouteV2CpiAccounts<'a, 'b> {
...
/// `swap_route_v2` CPI instruction.
pub struct SwapRouteV2Cpi<'a, 'b> {
    ...
    pub __args: SwapRouteV2InstructionArgs,
}

impl<'a, 'b> SwapRouteV2Cpi<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>, accounts: SwapRouteV2CpiAccounts<'a, 'b>, args: SwapRouteV2InstructionArgs) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapRouteV2` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
///   4. `[]` destination_mint
#[derive(Clone, Debug)]
pub struct SwapRouteV2CpiBuilder<'a, 'b> {
    instruction: Box<SwapRouteV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapRouteV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapRouteV2CpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let args =
            SwapRouteV2InstructionArgs { data: self.instruction.data.clone().expect("data is not set"), order_id: self.instruction.order_id.clone().expect("order_id is not set") };
        let instruction = SwapRouteV2Cpi {
...
#[derive(Clone, Debug)]
struct SwapRouteV2CpiBuilderInstruction<'a, 'b> {
