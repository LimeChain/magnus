...
pub const SWAP_V3_WITH_CPI_EVENT_DISCRIMINATOR: [u8; 8] = [184, 104, 79, 156, 107, 182, 120, 138];
...
impl SwapV3WithCpiEvent {
    pub fn instruction(&self, args: SwapV3WithCpiEventInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        &self,
        args: SwapV3WithCpiEventInstructionArgs,
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.destination_token_account, false));
        ...
        let mut data = SwapV3WithCpiEventInstructionData::new().try_to_vec().unwrap();
        let mut args = args.try_to_vec().unwrap();
        data.append(&mut args);

        solana_instruction::Instruction { program_id: crate::ROUTER_ID, accounts, data }
    }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapV3WithCpiEventInstructionData {
    discriminator: [u8; 8],
}

impl SwapV3WithCpiEventInstructionData {
    pub fn new() -> Self {
        Self { discriminator: [184, 104, 79, 156, 107, 182, 120, 138] }
    }
...
impl Default for SwapV3WithCpiEventInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapV3WithCpiEventInstructionArgs {
    pub data: SwapArgs,
    pub order_id: u64,
}

impl SwapV3WithCpiEventInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SwapV3WithCpiEvent`.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
pub struct SwapV3WithCpiEventBuilder {
...
impl SwapV3WithCpiEventBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    #[inline(always)]
    pub fn source_token_account(&mut self, source_token_account: solana_pubkey::Pubkey) -> &mut Self {
        self.source_token_account = Some(source_token_account);
        self
    }

    #[inline(always)]
    pub fn destination_token_account(&mut self, destination_token_account: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SwapV3WithCpiEvent {
        ...
        let args = SwapV3WithCpiEventInstructionArgs { data: self.data.clone().expect("data is not set"), order_id: self.order_id.clone().expect("order_id is not set") };

        accounts.instruction_with_remaining_accounts(args, &self.__remaining_accounts)
    }
}

/// `swap_v3_with_cpi_event` CPI accounts.
pub struct SwapV3WithCpiEventCpiAccounts<'a, 'b> {
...
/// `swap_v3_with_cpi_event` CPI instruction.
pub struct SwapV3WithCpiEventCpi<'a, 'b> {
    ...
    pub __args: SwapV3WithCpiEventInstructionArgs,
}

impl<'a, 'b> SwapV3WithCpiEventCpi<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>, accounts: SwapV3WithCpiEventCpiAccounts<'a, 'b>, args: SwapV3WithCpiEventInstructionArgs) -> Self {
        Self {
            __program: program,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(5 + remaining_accounts.len());
        accounts.push(solana_instruction::AccountMeta::new_readonly(*self.payer.key, true));
        accounts.push(solana_instruction::AccountMeta::new(*self.source_token_account.key, false));
        accounts.push(solana_instruction::AccountMeta::new(*self.destination_token_account.key, false));
        accounts.push(solana_instruction::AccountMeta::new_readonly(*self.source_mint.key, false));
        accounts.push(solana_instruction::AccountMeta::new_readonly(*self.destination_mint.key, false));
        ...
        let instruction = solana_instruction::Instruction { program_id: crate::ROUTER_ID, accounts, data };
...
/// Instruction builder for `SwapV3WithCpiEvent` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
///   4. `[]` destination_mint
#[derive(Clone, Debug)]
pub struct SwapV3WithCpiEventCpiBuilder<'a, 'b> {
    instruction: Box<SwapV3WithCpiEventCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapV3WithCpiEventCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapV3WithCpiEventCpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    #[inline(always)]
    pub fn source_token_account(&mut self, source_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
        self.instruction.source_token_account = Some(source_token_account);
        self
    }

    #[inline(always)]
    pub fn destination_token_account(&mut self, destination_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
        self.instruction.destination_token_account = Some(destination_token_account);
        self
    }

    #[inline(always)]
    pub fn source_mint(&mut self, source_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
        self.instruction.source_mint = Some(source_mint);
        self
    }

    #[inline(always)]
    pub fn destination_mint(&mut self, destination_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let args = SwapV3WithCpiEventInstructionArgs {
        ...
        let instruction = SwapV3WithCpiEventCpi {
...
#[derive(Clone, Debug)]
struct SwapV3WithCpiEventCpiBuilderInstruction<'a, 'b> {
