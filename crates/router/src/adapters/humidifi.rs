...
pub fn swap<'a>(
    ...
    if swap_accounts.dex_program_id.key != &pmm_humidifi::id() {
...
pub struct HumidifiAccountsV2<'info> {
    ...
    pub sysvar_instructions: &'info AccountInfo<'info>,
    pub token0_mint: &'info AccountInfo<'info>,
...
fn swap_v2_v3<'a>(
    ...
    let accounts = vec![
        ...
        AccountMeta::new(quote_account.key(), false),
        AccountMeta::new_readonly(swap_accounts.clok.key(), false),
        AccountMeta::new_readonly(swap_accounts.token0_program.key(), false),
        AccountMeta::new_readonly(swap_accounts.token1_program.key(), false),
        AccountMeta::new_readonly(swap_accounts.sysvar_instructions.key(), false),
        AccountMeta::new_readonly(swap_accounts.token0_mint.key(), false),
        AccountMeta::new_readonly(swap_accounts.token1_mint.key(), false),
        AccountMeta::new_readonly(swap_accounts.add1.key(), false),
        AccountMeta::new_readonly(swap_accounts.vote.key(), false),
    ];
    ...
    let account_infos = vec![
        ...
        quote_account.to_account_info(),
        swap_accounts.clok.to_account_info(),
        swap_accounts.token0_program.to_account_info(),
        swap_accounts.token1_program.to_account_info(),
        swap_accounts.sysvar_instructions.to_account_info(),
        swap_accounts.token0_mint.to_account_info(),
        swap_accounts.token1_mint.to_account_info(),
        swap_accounts.add1.to_account_info(),
        swap_accounts.vote.to_account_info(),
    ];
